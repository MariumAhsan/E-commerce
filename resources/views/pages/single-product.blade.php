    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span> <a href="shop-grid-right.html">{{$product->subcategory->name}}</a> <span></span>{{$product->name}}
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-xl-10 col-lg-12 m-auto">
                <div class="product-detail accordion-detail">
                            ...
                            <div class="detail-gallery">
                                ...
                                <div class="product-image-slider">
                                    ...
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('assets/images/' . $imageUrl) }}" alt="product image" />
                                    </figure>
                                    @endforeach
                                </div>
                                <!-- THUMBNAILS -->
                                <div class="slider-nav-thumbnails">
                                    @foreach($imageUrls as $imageUrl)
                                    <div><img src="{{ asset('assets/images/' . $imageUrl) }}" alt="product image" /></div>
                                    @endforeach
                                </div>
                            </div>
                            <!-- End Gallery -->
                            ...
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="clearfix product-price-cover">
                                    <div class="product-price primary-color float-left">
                                        <span class="current-price text-brand">Tk. {{$product->offer_price}}</span>
                                        <span>
                                            <span class="save-price font-md color3 ml-15">{{$discountPercentage}}% Off</span> <!--edit here--->
                                            <span class="old-price font-md ml-15">Tk. {{$product->price}}</span>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="font-xs">
                                    <ul class="mr-50 float-start">
                                        ...
                                        <li>EXP: <span class="text-brand">{{$product->exp_date}}</span></li>
                                    </ul>
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="comment-list">
                                                    <div class="single-comment justify-content-between d-flex mb-30">
                                                        <div class="user justify-content-between d-flex">
                                                            <div class="thumb text-center">
                                                                <img src="{{asset('assets')}}/assets/imgs/blog/author-2.png" alt="" />
                                                    ...
                                                    <div class="single-comment justify-content-between d-flex mb-30 ml-30">
                                                        <div class="user justify-content-between d-flex">
                                                            <div class="thumb text-center">
                                                                <img src="{{asset('assets')}}/assets/imgs/blog/author-3.png" alt="" />
                                                    ...
                                                    <div class="single-comment justify-content-between d-flex">
                                                        <div class="user justify-content-between d-flex">
                                                            <div class="thumb text-center">
                                                                <img src="{{asset('assets')}}/assets/imgs/blog/author-4.png" alt="" />
                    ...
                    <div class="row mt-60">
                        <div class="col-12">
                            <h2 class="section-title style-1 mb-30">Related products</h2> <!--show from that category/subcat-->
                        </div>
                        <div class="col-12">
